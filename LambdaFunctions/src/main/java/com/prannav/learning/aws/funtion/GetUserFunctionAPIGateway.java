...
public class GetUserFunctionAPIGateway implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        final String userId = queryParams == null ? null: StringUtils.trim(queryParams.get("userId"));


        if (userId == null || userId.equals("")) {
            return new APIGatewayProxyResponseEvent().withHeaders(HEADERS)
                                                     .withStatusCode(400)
                                                     .withBody("'userId' missing");
        }
        try {
            ...
            final UserData userData = userTable.getItem(Key.builder()
            ...
            return new APIGatewayProxyResponseEvent().withHeaders(HEADERS)
                                                     .withStatusCode(200)
                                                     .withBody(OBJECT_MAPPER.writeValueAsString(userData));
